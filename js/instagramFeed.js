            ...
            if (this.options.display_gallery) {
                ...
                if (typeof data.is_private !== "undefined" && data.is_private === true) {
                    ...
                    for (var i = 0; i < max; i++) {
                        ...
                        html += "<div class='instagram-feed-item'><div class='instagram-feed-inner'>";
                        html += "<a href='" + url + "' class='instagram-button instagram-" + type_resource + "' title='" + caption + "' rel='noopener' target='_blank'><img src='" + image + "' alt='" + caption + "'" + styles.gallery_image + " /></a>";

                        html += "<div class='instagram-feed-description'><p>" + caption.substring(0,70) + "</p>";
                        html += "<a href='" + url + "' class='instagram-button instagram-" + type_resource + "' title='" + caption + "' rel='noopener' target='_blank'>Read More</a></div></div></div>";
                    }
